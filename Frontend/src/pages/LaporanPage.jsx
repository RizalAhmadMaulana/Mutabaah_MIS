...
const LaporanPage = () => {
  ...
  useEffect(() => {
    if (!isWali) {
      const fetchKelas = async () => {
        try {
          const res = await axios.get("https://api-risalah.mentariku.org/api/academic/kelas/", { headers });
  ...
  const handleKelasChangeRekap = async (e) => {
    ...
    if (kelas !== "Semua") {
      try {
        const res = await axios.get(`https://api-risalah.mentariku.org/api/siswa/?kelas=${kelas}`, { headers });
  ...
  const handleSearchRekap = async () => {
    ...
    try {
      ...
      const res = await axios.get(`https://api-risalah.mentariku.org/api/academic/laporan/rekap_data/?dari_tgl=${dari_tgl}&sampai_tgl=${sampai_tgl}&kelas=${kelas}&siswa=${siswa}`, { headers });
  ...
  const handleDownloadPDF = async () => {
    try {
      ...
      const response = await axios({
        url: `https://api-risalah.mentariku.org/api/academic/laporan/download_pdf/?dari_tgl=${dari_tgl}&sampai_tgl=${sampai_tgl}&kelas=${kelas}&siswa=${siswa}`,
  ...
  const handleSearchRiwayat = async (filterWaktu = "semua") => {
    ...
    try {
      ...
      const res = await axios.get(`https://api-risalah.mentariku.org/api/academic/laporan/riwayat/?kelas=${kelas}&siswa=${siswa}&filter_waktu=${filterWaktu}`, { headers });
