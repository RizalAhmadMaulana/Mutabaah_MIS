...
const SetorHafalanPage = () => {
  ...
  return (
    <DashboardLayout title="Setor Hafalan">
      ...
      {activeModal === 'import' && (
        <ImportExcelModal onClose={() => setActiveModal(null)} onSuccess={() => { setActiveModal(null); fetchHafalan(); }} />
      )}
      ...
      <div className="flex flex-row gap-3 mb-6">
        <button onClick={() => { setSelectedHafalan(null); setActiveModal('add'); }} className="bg-[#5294A9] text-white rounded-[4px] px-3 py-2.5 font-[600] flex items-center justify-center gap-2 hover:opacity-90 transition-all shadow-sm w-1/2 sm:w-auto text-[0.85rem] sm:text-base whitespace-nowrap">
