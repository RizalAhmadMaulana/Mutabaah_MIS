...
const DataSiswaPage = () => {
  ...
  const rowData = [
    {
      id: 1, name: "Rizal Ahmad M", gender: "Laki Laki", nisn: "12345678", kelas: "1 A", ttl: "Semarang, 01/01/2010", telp: "089676440508"
    },
    {}, {}, {}, {}, {}, {}, {}, {}, {} // Mockup baris kosong
  ];
      ...
      <tr key={idx} className="even:bg-[#f2f2f2] hover:bg-slate-100 transition-colors">
        {row.id ? (
          <>
            ...
            <td className="border border-black px-3 py-2.5 text-center whitespace-nowrap">{row.nisn}</td>
  ...
  return (
    <DashboardLayout title="Data Siswa">
      ...
      {/* MODALS */}
      {activeModal === 'add' && <FormSiswaModal mode="add" onClose={handleClose} onSave={handleSaveAdd} />}
      {activeModal === 'edit' && <FormSiswaModal mode="edit" onClose={handleClose} onSave={handleSaveEdit} />}
      ...
      <div className="bg-white rounded-[8px] p-4 md:p-5 border-t-[5px] border-[#2ECC71] shadow-[0_4px_15px_rgba(0,0,0,0.05)]">
        ...
        <div className="border border-black rounded-[4px] overflow-x-auto bg-white mb-4 custom-scrollbar">
          {/* min-w-max agar tabel otomatis melebar sesuai kontennya yang banyak */}
